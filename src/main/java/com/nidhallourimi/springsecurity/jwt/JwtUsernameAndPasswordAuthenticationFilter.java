package com.nidhallourimi.springsecurity.jwt;
...
public class JwtUsernameAndPasswordAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        String token = Jwts.builder()
                ...
                .signWith(Keys.hmacShaKeyFor("securesecuresecuresecuresecuresecuresecuresecuresecuresecuresecuresecure".getBytes()))//it should be long and not exposed
                .compact();
